  ...
  return (
    <section className="relative w-full flex flex-col md:flex-row items-center justify-between min-h-[400px] md:min-h-[500px] bg-white px-4 md:px-8">
      ...
      <div className="flex-1 flex flex-col items-start justify-center pl-0 md:pl-16 mt-12 md:mt-0 relative z-20">
        ...
        <a href="/about" className="px-8 py-3 bg-pink-600 text-white font-semibold text-lg rounded-full shadow-soft hover:bg-sky-500 transition-all duration-300 font-fredoka">
          Read More
        </a>
      </div>
