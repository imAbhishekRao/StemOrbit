...
export default function SassyContactSection() {
  return (
    <section className="w-full py-8 sm:py-12 lg:py-16 flex flex-col items-center justify-center text-center bg-white px-4 sm:px-6">
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-comicneue font-extrabold text-pink-600 mb-4 sm:mb-6 drop-shadow-lg">
        Do you have a question or you want to connect?
      </h2>
      <p className="text-base sm:text-lg lg:text-xl font-bubblegum text-cyan-800 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
