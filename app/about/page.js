    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full py-20 px-4 md:px-0 bg-white">
        <div className="max-w-5xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Innovative Learning Labs</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          <div className="rounded-2xl bg-blue-100 p-8 shadow-sm flex flex-col items-start">
            <div className="text-2xl font-bold text-blue-700 mb-2">AI LABS</div>
            <div className="text-gray-600 text-base">Explore the world of Artificial Intelligence with hands-on projects and interactive learning modules.</div>
          </div>
          <div className="rounded-2xl bg-pink-100 p-8 shadow-sm flex flex-col items-start">
            <div className="text-2xl font-bold text-pink-700 mb-2">ROBOTICS LABS</div>
            <div className="text-gray-600 text-base">Build, program, and experiment with robots to develop problem-solving and engineering skills.</div>
          </div>
          <div className="rounded-2xl bg-purple-100 p-8 shadow-sm flex flex-col items-start">
            <div className="text-2xl font-bold text-purple-700 mb-2">STEM LABS</div>
            <div className="text-gray-600 text-base">Engage in a variety of STEM activities that encourage innovation and scientific thinking.</div>
          </div>
          <div className="rounded-2xl bg-green-100 p-8 shadow-sm flex flex-col items-start">
            <div className="text-2xl font-bold text-green-700 mb-2">3D DESIGN</div>
            <div className="text-gray-600 text-base">Unleash creativity with 3D modeling and design, bringing ideas to life through digital creation.</div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-20 px-4 md:px-0 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">A Brief History</h2>
          <div className="overflow-x-auto">
            <div className="flex min-w-[900px] md:min-w-full gap-12 pb-8 relative">
              {/* Horizontal line */}
      ...
      <section className="w-full py-0 px-0 bg-white">
        <div className="relative w-full overflow-hidden">
          <div
            className="flex gap-10 w-max animate-slide-infinite"
